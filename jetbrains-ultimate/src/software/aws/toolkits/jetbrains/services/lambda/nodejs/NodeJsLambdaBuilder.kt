...
/**
 * TODO The Lambda Builder logic is the same to Python. We should refactor this a bit to make [getBaseDirectory] method
 * abstract and move the [buildLambda] to super class.
 */
