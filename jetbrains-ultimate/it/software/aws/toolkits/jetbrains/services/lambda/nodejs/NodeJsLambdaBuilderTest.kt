...
import softwere.aws.toolkits.jetbrains.utils.rules.addNodeJsHandler
...
class NodeJsLambdaBuilderTest : BaseLambdaBuilderTest() {
    ...
    fun contentRootIsAdded() {
        ...
        val handler = projectRule.fixture.addNodeJsHandler(subPath, fileName, handlerName)
    ...
    fun builtFromTemplate() {
        ...
        projectRule.fixture.addNodeJsHandler(subPath, fileName, handlerName)
        projectRule.fixture.addPackageJsonFile(subPath)
    ...
    fun packageLambdaIntoZip() {
        ...
        val handler = projectRule.fixture.addNodeJsHandler(subPath)
        projectRule.fixture.addPackageJsonFile("")
